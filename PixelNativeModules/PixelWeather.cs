...
namespace PixelNativeModules
{
    public class PixelWeather : PixelModule
    {
        ...
        public PixelWeather()
        {
            ...
            WeatherImages.Add("Humidity", Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Humidity.png")));
            
            GifWeatherImages.Add("Thunderstorm", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Thunderstorm.gif"))));
            GifWeatherImages.Add("Drizzle", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Drizzle.gif"))));
            GifWeatherImages.Add("Rain", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Rain.gif"))));
            GifWeatherImages.Add("Snow", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Snow.gif"))));
            GifWeatherImages.Add("Mist", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Mist.gif"))));
            GifWeatherImages.Add("Clear", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Clear.gif"))));
            GifWeatherImages.Add("ClearNight", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Clear_night.gif"))));
            GifWeatherImages.Add("Clouds", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.fewClouds.gif"))));
            GifWeatherImages.Add("CloudsNight", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Clouds.gif"))));
            GifWeatherImages.Add("Wind", new GifImage(Image.FromStream(assembly.GetManifestResourceStream($"PixelNativeModules.Weather.Wind.gif"))));
